...
typedef struct _dict {
	unsigned long long count; //number of sequences stored
...
/* Initialize first 256 sequences in the dictionary */
void initDict(Dict *dict, Sequence **seq, int direction, unsigned long long hashSize);
